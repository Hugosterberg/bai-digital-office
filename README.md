...
| [`office/`](./office/README.md) | **bai digital office** — the cockpit: write tasks → GitHub issues → agents build → PR review board. |
...
1. Hugo writes a task in **bai digital office** (`office/`) — context, build steps,
